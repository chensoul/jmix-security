...
public class OAuth2PasswordCredentialsAuthenticationProvider implements AuthenticationProvider {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OAuth2PasswordCredentialsAuthenticationProvider.class);
    ...
    public OAuth2PasswordCredentialsAuthenticationProvider(OAuth2TokenGenerator<? extends OAuth2Token> tokenGenerator, AuthenticationManager authenticationManager, OAuth2AuthorizationService authorizationService) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        OAuth2PasswordCredentialsAuthenticationToken resourceOwnerPasswordAuthentication =
    ...
    private Authentication authenticateUserInJmix(
            OAuth2PasswordCredentialsAuthenticationToken authenticationToken) {
